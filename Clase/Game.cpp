...
void Game::create_piece(sf::Texture & texture, sf::Sprite & sprite, std::string texture_name, int x_final, int y_final, int x, int y, int n_piece) {
    ...
    sprite.setScale(100.0 f / x_final, 100.0 f / y_final);
...
void Game::move_pieces(std::vector < sf::Texture > & textures, std::vector < sf::Sprite > & sprites) {
    ...
    tex.push_back("Texturi/whitebishop.png");
    tex.push_back("Texturi/whitebishop.png");
    tex.push_back("Texturi/blackbishop.png");
    tex.push_back("Texturi/blackbishop.png");
    ...
    poz_y.push_back(1);
    poz_y.push_back(6);
    tex.push_back("Texturi/whiteknight.png");
    tex.push_back("Texturi/whiteknight.png");
    tex.push_back("Texturi/blackknight.png");
    tex.push_back("Texturi/blackknight.png");
    ...
    poz_y.push_back(0);
    poz_y.push_back(7);
    tex.push_back("Texturi/whiterook.png");
    tex.push_back("Texturi/whiterook.png");
    tex.push_back("Texturi/blackrook.png");
    tex.push_back("Texturi/blackrook.png");
